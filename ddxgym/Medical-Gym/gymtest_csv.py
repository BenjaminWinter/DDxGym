...
def run_env():
    ...
    for _ in range(10_000):
        ...
        while not done:
            ...
            creward += r
            elen+= 1
        episode_rewards.append(creward)
        episode_lens.append(elen)
    return np.mean(episode_rewards), np.mean(episode_lens)

res = Parallel(n_jobs=64)(delayed(run_env)() for _ in range(10))
print(res)
exit()
...
# print(".................................")
# for k, d in env.diseases.items():
#     msymptom = d.main_symptom
#     if len(msymptom.examinations) == 0 or len(msymptom.treatments) == 0:
#         print(msymptom.name)
...
print(f"Mean Len: {np.mean(episode_lens)}")
exit()
while 1==1:
    obs = env.reset()
