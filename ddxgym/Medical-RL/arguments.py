...
def parseArguments() -> Namespace:
    ...
    parser.add_argument("--fruitfly", action='store_true', help="Use the fruitfly model")
    parser.add_argument("--predict_disease", action='store_true', help="use disease predictin auxiliary loss")
    parser.add_argument("--freeze_encoder", action='store_true', help="freeze encoder")
    parser.add_argument("--is_csv", action='store_true', help="Use labeled csv data")
    ...
    parser.add_argument("--max_diseases", type=int, default=256, help="Limit number of diseases to simplify problem")
    ...
    parser.add_argument("--log_dir", type=str, default="~/ray_results", help="Directory for Ray logs")
    parser.add_argument("--fruitfly_model_path", type=str, default=None, help="fruitfly checkpoint")
    parser.add_argument("--fruitfly_tokenizer", type=str, default='microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext', help="fruitfly tokenizer")
    parser.add_argument("--checkpoint_frequency", type=int, default=50, help="Frequency of checkpoints")
    parser.add_argument("--transformer_mlm", action='store_true', help="Use mlm custom objective")
    parser.add_argument("--sequence_lstm", action='store_true', help="use sequence lstm model")
    parser.add_argument("--fruitfly_model_fs", type=str, default=None, help="frequencies of words of the environment to load")
